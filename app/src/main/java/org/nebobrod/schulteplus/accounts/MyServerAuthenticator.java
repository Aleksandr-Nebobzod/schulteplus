package org.nebobrod.schulteplus.accounts;
...
public class MyServerAuthenticator extends Service implements IServerAuthenticator  {
	...
	public String signUp(String email, String username, String password) {
		// TODO: 08.10.2023   register new user on the server and return its auth token
		return null;
	}
